...
const submitHandler = async () => {
    ...
    try {
        const res = await $fetch(`${EndPoint}/forgetPassword`,
            {
                method: "POST",
    ...
    <NuxtLayout :name="home">
        ...
        <div class="grid w-full grid-cols-12 gap-5 py-10">
            ...
            <div class="col-span-12 lg:col-span-7 xl:col-span-6">
                <img src="/images/forgot.jpg" alt="Sign Up Image" class="w-full h-full" />
            </div>
            <!-- Form -->
            <div class="col-span-12 pl-0 lg:col-span-5 lg:content-center xl:pl-20 xl:col-span-6">
                <div class="w-full p-4 rounded-md lg:pe-36">
                    <div class="text-center lg:text-left">
                        <h2 class="mb-4 text-3xl font-bold">Forgot Password</h2>
                        ...
                        <form @submit.prevent="submitHandler" class="pt-6 text-center lg:text-left">
                            ...
                            <div class="flex flex-col items-center  w-full gap-2 lg:gap-6  md:flex-row md:w-4/5">
                                ...
                                <Button type="submit"
                                    class="w-full py-3 mb-0 text-white rounded-md lg:w-3/6 md:w-3/5 bg-primary hover:bg-danger">Reset
                                    Password</Button>

                            </div>

                            <!-- <NuxtLink to="/account/reset" class="flex flex-col items-center  w-full gap-2 lg:gap-6  md:flex-row md:w-4/5">
                                <Button @click="submit" type="submit" class="w-full py-3 mb-0 text-white rounded-md lg:w-3/6 md:w-3/5 bg-primary hover:bg-danger">Reset Password</Button>
                            </NuxtLink> -->
                        </form>
                    </div>
            ...
            <div :class="{ 'absolute top-[8rem] right-0 z-20 p-2 shadow-sm round-md': true, 'hidden': !popUp }">
